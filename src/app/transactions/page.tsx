    ...
    return (
        <DashboardLayout>
            ...
            <section className='bg-[#FBFBFB] w-full'>
               <div className='py-6 px-8   border-b w-full flex-col md:flex-row  flex justify-between'>
                    <h3 className='hidden md:inline-block font-semibold'>All Accounts</h3>
               <div className='flex md:hidden justify-between w-full py-3'>
               <h3 className='font-semibold'>All Accounts</h3>
                ...
                <div className='text-textgray flex flex-col sm:flex-row gap-2 items-center'>
